        ...
        echo('<ul>');
            ...
            echo('<li>');
                echo('<a href="paginaprincipal.php">');
                    ...
                    echo('<span >Página Principal</span>');
                echo('</a>');
            echo('</li>');
            echo('<li>');
                echo('<a href="servicios.php?status=En%20proceso">');
        ...
        echo('<div class="usuario">');
            ...
            echo('<div class="info-usuario">');
                echo('<div class="nombre-email">');
                    echo('<span class="nombre">' .$_SESSION["Name"] .'</span>');
                    echo('<span class="nombre">' .$_SESSION["Last_name"] .'</span>');
